...
def time_multiply(x, y, f):
    ...
    subquadratic_multiply(BinaryNumber(x), BinaryNumber(y))
    return (time.time() - start)*1000

print(time_multiply(10000000,100000000,subquadratic_multiply))
print(time_multiply(100000000,1000000000,subquadratic_multiply))
print(time_multiply(1000000000,10000000000,subquadratic_multiply))
print(time_multiply(10000000000,100000000000,subquadratic_multiply))
